...
const updatePublicidade = function (req, res){
    functions.service(query.publicidade.update, req, res, [req.body.titulo, req.body.titulo, req.body.texto, req.body.link, req.body.flgAtivo, req.body.idImagem, req.body.id], "", modelPublicidade, false);
}
/* end-Services */
